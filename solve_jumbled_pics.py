...
def rename_files():
	...
	# using os.listdir()
    list_of_files = os.listdir(r'C:\Users\Shaurya Singhal\Desktop\Machine Learning\jumbled_photos')
    print(list_of_files)
    ...
    os.chdir(r'C:\Users\Shaurya Singhal\Desktop\Machine Learning\jumbled_photos')
